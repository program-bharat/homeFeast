...
import { getProfile, updateProfile, changePassword } from '../api/userAPI.js'; // Imported changePassword
...
const LiftCard = ({ children, className = '' }) => (
    <section
        className={`reveal dealy-1 bg-white p-6 rounded-xl shadow-sm border border-[var(--color-border)]/30 transition-all duration-300 hover:shadow-md ${className}`}
    >
        {children}
    </section>
);
        ...
        <>
            ...
            {isPasswordModalOpen && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fadeIn">
                    <div className="bg-white w-full max-w-md rounded-xl shadow-xl border border-[var(--color-border)]/50 overflow-hidden transform transition-all scale-100">
